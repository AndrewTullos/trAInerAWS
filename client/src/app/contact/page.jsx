      ...
      <form>
        ...
        <div className="isolate mt-6 -space-y-px rounded-2xl bg-white/20">
          ...
          <div className="border border-neutral-300 px-6 py-8 first:rounded-t-2xl last:rounded-b-2xl">
            <fieldset>
              <legend className="text-base/6 text-neutral-50">Budget</legend>
...
function ContactDetails() {
  return (
    <FadeIn>
      ...
      <p className="mt-6 text-base text-neutral-100">
      ...
      <Border className="mt-16 pt-16">
        ...
        <dl className="mt-6 grid grid-cols-1 gap-8 text-sm sm:grid-cols-2">
          {[
            ['Careers', 'careers@trainerfit.com'],
            ['Press', 'press@trainerfit.com'],
          ].map(([label, email]) => (
            <div key={email}>
              <dt className="font-semibold text-neutral-100">{label}</dt>
              <dd>
                <Link
                  href={`mailto:${email}`}
                  className="text-neutral-200 hover:text-neutral-50 hover:underline"
                >
                  {email}
                </Link>
              </dd>
